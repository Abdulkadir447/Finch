...
export const type: Record<string, TypeStyle> = {
  ...
  pageTitle: { fontSize: 32, lineHeight: 40, fontWeight: 700, letterSpacing: -0.02 },
  // 24/32/700 — mobile page titles
  pageTitleMobile: { fontSize: 24, lineHeight: 32, fontWeight: 700, letterSpacing: -0.01 },
  // 20/28/600 — section & card headings
  sectionHeading: { fontSize: 20, lineHeight: 28, fontWeight: 600, letterSpacing: 0 },
  ...
  bodyDefault: { fontSize: 16, lineHeight: 24, fontWeight: 400, letterSpacing: 0 },
  // 14/20/400 — dense tables, secondary descriptions
  bodyCompact: { fontSize: 14, lineHeight: 20, fontWeight: 400, letterSpacing: 0 },
